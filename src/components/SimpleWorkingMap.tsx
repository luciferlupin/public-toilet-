...
export default function SimpleWorkingMap({ toilets, userLocation, selectedToilet, onToiletSelect }: SimpleWorkingMapProps) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      if (!mapRef.current) {
        ...
        setError("Map container could not be initialized");
        return;
      }

      const loadMap = async () => {
        try {
          console.log("Starting map initialization, container found:", !!mapRef.current);

          // Dynamically load Leaflet
          const L = await import('leaflet');
          
          // Set up Leaflet CSS and fix marker icons
          ...
          console.log("Creating map at center:", center);
  ...
  useEffect(() => {
    ...
    console.log("Loading markers for toilets:", toilets.length);
